...
import com.github.da.DataModelCreator;
...
public class TM1 {
	public static void main(String[] args) throws URISyntaxException, IOException {
		try {
			...
			// properties).getMetamodel();

			DatabaseModel hib = TM.Holder.dm;

			Class<?> c = Bottom1.class;
			Path p = findDir(c);
			ClassHierarchy ch = DeploymentAnalyserMain.doit(p.toString());
			DatabaseModel dm = DataModelCreator.create(ch);
